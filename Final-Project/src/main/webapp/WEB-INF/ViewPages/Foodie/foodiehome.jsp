...
<body style="background-color:rgb(206, 203, 36); background-image:url('log.jpeg'); background-size: cover;">
    ...
    <div  class="container-fluid" >
        ...
        <div class="row">
            <div class="text-center">
                 <h2 style="color: rgb(240, 93, 9);">FOODIE HOME</h2>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 text-center">
                <h1 style="font-style:italic; color: maroon;">WELCOME ${f.firstname}</h1>  
                <h1 style="font-style:italic; color: maroon;">Your foodie id is ${f.foodieid}</h1>  
            </div>
            <div class="col-lg-4 text-center">
            </div>
        </div>
