    ...
    <div  class="container-fluid" >
        ...
        <div class="row">
            <div class="text-center">
                 <h2 style="color: rgb(240, 93, 9);">VIEWREVIEW</h2>
            </div>
        </div>
	    	...
	    	<div class="col-md-8" >
                ...
                <div class="row"  >
                    ...
                    <div class="col-md-6" style="text-align: center;background-color:rgb(172, 199, 110)">
                        <h5 style="color: maroon;text-decoration: underline; ">REVIEWS BY YOU</h5>
                    </div>
                    <div class="col-md-3"></div>
                </div>
                ...
                <table width="100%" class="table table-striped" border="1" style="text-align:center; background-color:wheat; border-spacing:12px;">
                    ...
                    <tr>
                        ...
                        <td><a href="vendshow/${v.vendorname }">${r.vendorname }</a></td>
                        <td>${r.location }</td>
                        ...
                        <td>
                          <div class="col-12" style="text-align: center;">
                            <button type="submit" name="editreview" id="editreview"  class="btn btn-success">Edit Review</button>
                          </div>
                        </td>
                        <td>
                          <div class="col-12" style="text-align: center;">
                            <button type="submit" name="deletereview" id="deletereview"  class="btn btn-success">Delete Review</button>
                          </div>
                        </td>
