            ...
            <div class="container-fluid">
              ...
              <div class="navbar navbar-dark bg-primary" id="navbarNavAltMarkup">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                 ...
                 <li class="nav-item">
                    <a class="nav-link active"  href="#">Foodie Details</a>
                  </li>&nbsp; &nbsp; &nbsp; &nbsp;
                  <li class="nav-item">
                    <a class="nav-link active"  href="#">View Review</a>
                  </li>&nbsp; &nbsp; &nbsp; &nbsp;
                  <li class="nav-item">
                    <a class="nav-link active"  href="#">View Complaint</a>
                  </li>&nbsp; &nbsp; &nbsp; &nbsp;
                  <li class="nav-item">
                    <a class="nav-link active"  href="#">Generate Report</a>
                  </li>&nbsp; &nbsp; &nbsp; &nbsp;
                  <li class="nav-item">
	    	...
	    	<div class="col-md-8" >
                ...
                <div class="row"  >
                    ...
                    <div class="col-md-6" style="text-align: center;background-color:rgb(172, 199, 110)">
                        <h5 style="color: maroon;text-decoration: underline; ">VENDOR DETAILS</h5>
                    </div>
                    <div class="col-md-3"></div>
                </div>
                ...
                <table width="100%" class="table table-striped" border="1" style="text-align:center; background-color:wheat; border-spacing:12px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-block btn-info mb-1" href="activate/${v.vendorid }">Activate</a>
                        </td>
                        <td>
                            <a class="btn btn-block btn-info mb-1"    href="deactivate/${v.vendorid }">Deactivate</a>
                        </td>
                        <td>
                            <a class="btn btn-block btn-info mb-1"    href="delete/${v.vendorid }">Delete</a>
                        </td>
                    </tr>
                    </c:forEach>
                </table>
