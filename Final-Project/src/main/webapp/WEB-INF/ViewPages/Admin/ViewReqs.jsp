    ...
    <div  class="container-fluid" >
        ...
        <div class="row">
            <div class="text-center">
                 <h2 style="color: rgb(240, 93, 9);">VENDOR REQUESTS</h2>
            </div>
        </div>
	    	...
	    	<div class="col-md-8" >
                ...
                <div class="row"  >
                    ...
                    <div class="col-md-6" style="text-align: center;background-color:rgb(172, 199, 110)">
                        <h5 style="color: maroon;text-decoration: underline; ">NEW VENDOR REQUEST DETAILS</h5>
                    </div>
                    <div class="col-md-3"></div>
                </div>
                ...
                <table width="100%" class="table table-striped" border="1" style="text-align:center; background-color:wheat; border-spacing:12px;">
                    ...
                    <tr>
                        ...
                        <td>${v.cusinetype }</td>
                        <td>
                            <a class="btn btn-block btn-info mb-1" href="acceptvendor/${v.vendorid }">Accept</a>
                        </td>
                        <td>
                            <a class="btn btn-block btn-info mb-1"    href="rejectvendor/${v.vendorid }">Reject</a>
                        </td>
                    </tr>
                    </c:forEach>
                </table>
